                ...
                <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
                     <table class="table table-borderless">
                         ...
                         <tr>
                             <th style="width: 40%">First Name</th>
                             <td style="width: 60%">${employee.firstName}</td>
                         </tr>

                         <tr>
                             <th style="width: 40%">Middle Name</th>
                             <td style="width: 60%">${employee.middleName}</td>
                         </tr>
                         <tr>
                              <th style="width: 40%">Last Name</th>
                              <td style="width: 60%">${employee.lastName}</td>
                         </tr>
                         <tr>
                         ...
                         <tr>
                             <th style="width: 40%">Address</th>
                             <td style="width: 60%">${employee.employeeAddress}</td>
                         </tr>
                     </table>
                </div>
